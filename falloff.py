...
"""
This file generates graphs for linearly-dependent coupling 1 + 0.5 x, but with
very low tunneling amplitudes so that the leads do not broaden the level very
much, and the dominant effect on the density of states is thermal broadening.
"""
...
for k in (0.6, -0.3):
    ...
    render(xs, ys, ref, '/tmp/falloff_%s.ps' % k)
